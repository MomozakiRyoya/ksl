...
const SPONSORS = [
  {
    ...
    description:
      "株式会社ReafはAI開発・コンサルティング事業を展開する鹿児島発のテクノロジー企業です。本KSLアプリの開発・提供を担っています。",
    website: null,
  },
  {
    id: 1,
    ...
    badge: "オフィシャルスポンサー",
    description:
      "鹿児島を拠点に次世代のフットサル選手育成に取り組むアカデミーです。KSLの公式スポンサーとして活動を支援しています。",
    website: null,
  },
  {
    id: 2,
    ...
    badge: "パートナー",
    description:
      "博多を中心に地域スポーツの振興に貢献するスポーツクラブです。KSLのパートナーとして地域コミュニティの発展を目指しています。",
    website: null,
  },
];
