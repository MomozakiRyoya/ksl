...
const MOCK_GALLERY: GalleryItem[] = [
  ...
  { id: 2, round: "第4節", league: "Division 1", caption: "加藤蓮 ハットトリック達成の瞬間", date: "2026-03-22", color: "#be185d" },
  { id: 3, round: "第4節", league: "Division 2", caption: "熱戦！Division 2 第4節", date: "2026-03-22", color: "#8B5CF6" },
  { id: 4, round: "第3節", league: "Division 1", caption: "鹿児島ユナイテッド 逆転勝利", date: "2026-03-15", color: "#10B981" },
  { id: 5, round: "第3節", league: "Division 1", caption: "MVP 木村遼 インタビュー", date: "2026-03-15", color: "#db2777" },
  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      <div
        ...
        style={{
          background: "linear-gradient(135deg, #be185d 0%, #db2777 60%, #be185d 100%)",
        }}
      >
        ...
        <div className="relative flex items-center justify-between">
          <div>
            <p className="text-white/50 text-xs tracking-[0.25em] uppercase mb-1">KSL Season 1</p>
        ...
        {filtered.map((item) => (
          ...
          >
            ...
            <div
              ...
              style={{
                background: `linear-gradient(135deg, ${item.color} 0%, ${item.color}99 50%, #be185d 100%)`,
              }}
            />
            {/* イニシャル */}
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                background: `linear-gradient(135deg, ${selectedItem.color} 0%, ${selectedItem.color}99 50%, #be185d 100%)`,
              }}
            >
              <div className="absolute inset-0 flex items-center justify-center">
            ...
            <div className="bg-white px-5 py-4">
              <div className="flex items-center gap-2 mb-2">
                <span
                  ...
                  style={{ background: "#f1f5f9", color: "#be185d" }}
                >
                  {selectedItem.round}
                </span>
