              ...
              .map((p) => (
                ...
                >
                  ...
                  <td
                    ...
                    style={{ color: p.rank <= 3 ? "#c9921e" : "#be185d" }}
                  >
                    {p.pts} pt
                  </td>
                </tr>
        ...
        <div className="flex items-center gap-2 mb-1">
          ...
          <span
            ...
            style={{
              ...
              color:
                round.status === "next" ? "#be185d" : "rgba(255,255,255,0.8)",
            }}
          >
      ...
      <div className="px-4 py-6 space-y-5">
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      ...
                      style={{ color: isTop ? "#c9921e" : "#be185d" }}
                    >
                      {result.points}pt
                    </span>
                  </div>
        ...
        <div className="animate-fade-in animate-delay-200">
          <a
            ...
            style={{ background: "rgba(201,146,30,0.06)", color: "#be185d" }}
          >
            <svg
              className="w-4 h-4"
              fill="none"
